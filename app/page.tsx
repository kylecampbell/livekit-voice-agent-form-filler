...
export default function Page() {
  ...
  useEffect(() => {
    ...
    room.on(RoomEvent.DataReceived, (payload: Uint8Array, participant) => {
      ...
      console.log(`Data from ${participant?.identity ?? "unknown"}:`, data);
      ...
      console.log("Updated formData:", {
        name: data.customer_name ?? formData.name,
        phone: data.customer_phone ?? formData.phone,
        email: data.customer_email ?? formData.email,
      });
  ...
  return (
    <main data-lk-theme="default" className="h-full grid grid-cols-2 bg-[var(--lk-bg)]">
